...
class FoodForNeadyAboutUs extends StatefulWidget {
  const FoodForNeadyAboutUs({Key? key}) : super(key: key);

  @override
  State<FoodForNeadyAboutUs> createState() => _FoodForNeadyAboutUsState();
}

// ignore: camel_case_types
class _FoodForNeadyAboutUsState extends State<FoodForNeadyAboutUs> {
  int activeIndex = 0;
                  ...
                  Container(
                    decoration: BoxDecoration(
                      ...
                      image: const DecorationImage(
                          image: AssetImage(
                              "assets/AboutUsDonation/FoodForNeedy/1.jpeg"),
                          fit: BoxFit.cover),
                    ),
                  ),
                  Container(
                    decoration: BoxDecoration(
                        ...
                        image: const DecorationImage(
                            image: AssetImage(
                                "assets/AboutUsDonation/FoodForNeedy/2.jpeg"),
                            fit: BoxFit.cover)),
                  ),
                  Container(
                    decoration: BoxDecoration(
                        ...
                        image: const DecorationImage(
                            image: AssetImage(
                                "assets/AboutUsDonation/FoodForNeedy/3.jpeg"),
                            fit: BoxFit.cover)),
                  ),
                  Container(
                    decoration: BoxDecoration(
                        ...
                        image: const DecorationImage(
                            image: AssetImage(
                                "assets/AboutUsDonation/FoodForNeedy/4.jpeg"),
                            fit: BoxFit.cover)),
                  ),
                ],
                //for slider option
